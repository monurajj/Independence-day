        ...
        {isHosting && (
          ...
          >
            ...
            <div className="relative h-[80vh] w-full max-w-2xl flex justify-center">
              ...
              {/* Enhanced Flagpole with base */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
                {/* Pole base */}
                <motion.div 
                  className="w-16 h-8 bg-gradient-to-t from-stone-600 to-stone-400 rounded-lg mb-2"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              {/* Enhanced Flag with realistic movement */}
              <motion.div
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.h3 
                        ...
                        animate={{ 
                          background: [
                            "linear-gradient(45deg, #FF9933, #138808)",
                            "linear-gradient(45deg, #138808, #FF9933)",
                            "linear-gradient(45deg, #FF9933, #138808)"
                          ]
                        }}
                        transition={{ duration: 3, repeat: Infinity }}
